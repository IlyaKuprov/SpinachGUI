...
System::Void SpinachGUI::Spinach::WriteFooter()
{
	...
	String ^coord, ^temp;
	double trace=0.0f;
	cli::array<cli::array<String^>^>^ CouplingMatrix=gcnew cli::array<cli::array<String^>^>(AtomCollection->Count);
	cli::array<String^>^ ZeemanMatrix=gcnew cli::array<String^>(AtomCollection->Count);
	//Coordinates etc////////////////////////////////////////////////////////////////////////////////////////
	...
	{
		CouplingMatrix[i]=gcnew cli::array<String^>(AtomCollection->Count);
...
System::Void SpinachGUI::Spinach::Exportbutton_Click(System::Object^  sender, System::EventArgs^  e)
{
	...
	if (saveFileDialog->ShowDialog() == System::Windows::Forms::DialogResult::OK )
	{
		...
		cli::array<Byte>^ info = (gcnew UTF8Encoding( true ))->GetBytes(final);
